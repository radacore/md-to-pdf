...
async function convertMdToPdf(mdContent, paperSize = 'single', flowchartWidth = 70) {
    ...
    try {
        ...
        // Ensure flowchartWidth is a valid number between 30-100
        const validFlowchartWidth = Math.min(100, Math.max(30, flowchartWidth));
        console.log('Using flowchart width:', validFlowchartWidth + '%');
...
<head>
    ...
    <style>
        ...
        /* Flowchart - dynamic width from user setting, centered */
        .mermaid-tb {
            width: ${validFlowchartWidth}%;
            margin-left: auto;
            margin-right: auto;
        }
    ...
    <script>
      ...
      `;
        ...
        if (paperSize === 'a4') {
            ...
            // Add single-page-mode class to body to prevent page breaks
            await page.evaluate(() => {
                document.body.classList.add('single-page-mode');
            });

            // Wait for all content to fully render (images, fonts, etc.)
            ...
            const bodyHeight = await page.evaluate(() => {
                ...
                if (content) {
                    ...
                    // Get all child elements and find the actual bottom
                    ...
                    return maxBottom + marginBottom + 50; // Add extra padding
                }
            ...
            // Add buffer for margin and ensure it fits in one page
            const pdfHeight = bodyHeight + 100;
            console.log('Calculated PDF height:', pdfHeight, 'px');
            ...
            pdfOptions = {
                ...
                printBackground: true,
                preferCSSPageSize: false  // Force our custom page size
            };
        }
